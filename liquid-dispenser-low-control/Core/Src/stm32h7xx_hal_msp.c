...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
    ...
    */
    ...
    HAL_GPIO_Init(APDS9960_SDA_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = APDS9960_SCL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF4_I2C3;
    HAL_GPIO_Init(APDS9960_SCL_GPIO_Port, &GPIO_InitStruct);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==I2C3)
  {
    ...
    PA8     ------> I2C3_SCL
    */
    HAL_GPIO_DeInit(APDS9960_SDA_GPIO_Port, APDS9960_SDA_Pin);

    HAL_GPIO_DeInit(APDS9960_SCL_GPIO_Port, APDS9960_SCL_Pin);
...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  if(htim_encoder->Instance==TIM1)
  {
    ...
    PE11     ------> TIM1_CH2
    */
    GPIO_InitStruct.Pin = SYRINGE_ENC_A_Pin|SYRINGE_ENC_B_Pin;
...
void HAL_TIM_IC_MspInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  if(htim_ic->Instance==TIM12)
  {
    ...
    PB15     ------> TIM12_CH2
    */
    GPIO_InitStruct.Pin = CUP_1_ECHO_Pin|CUP_2_ECHO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM2)
  {
    ...
    PA15(JTDI)     ------> TIM2_CH1
    */
    GPIO_InitStruct.Pin = LID_SEAL_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLDOWN;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(LID_SEAL_PWM_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(htim->Instance==TIM3)
  {
    ...
    PA6     ------> TIM3_CH1
    */
    GPIO_InitStruct.Pin = LID_TRANSLATE_1_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(LID_TRANSLATE_1_PWM_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(htim->Instance==TIM4)
  {
    ...
    PD12     ------> TIM4_CH1
    */
    GPIO_InitStruct.Pin = LID_TRANSLATE_2_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM4;
    HAL_GPIO_Init(LID_TRANSLATE_2_PWM_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(htim->Instance==TIM5)
  {
    ...
    PA0     ------> TIM5_CH1
    */
    GPIO_InitStruct.Pin = GANTRY_Y_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM5;
    HAL_GPIO_Init(GANTRY_Y_PWM_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(htim->Instance==TIM8)
  {
    ...
    PC7     ------> TIM8_CH2
    */
    GPIO_InitStruct.Pin = CUP_1_PWM_Pin|CUP_2_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  else if(htim->Instance==TIM15)
  {
    ...
    PE5     ------> TIM15_CH1
    */
    GPIO_InitStruct.Pin = SYRINGE_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF4_TIM15;
    HAL_GPIO_Init(SYRINGE_PWM_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(htim->Instance==TIM23)
  {
    ...
    PF2     ------> TIM23_CH3
    */
    GPIO_InitStruct.Pin = GANTRY_X_PWM_Pin|GANTRY_X2_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  else if(htim->Instance==TIM24)
  {
    ...
    PF12     ------> TIM24_CH2
    */
    GPIO_InitStruct.Pin = LID_ROTATE_1_PWM_Pin|LID_ROTATE_2_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  if(htim_encoder->Instance==TIM1)
  {
    ...
    PE11     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(GPIOE, SYRINGE_ENC_A_Pin|SYRINGE_ENC_B_Pin);
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* htim_ic)
{
  if(htim_ic->Instance==TIM12)
  {
    ...
    PB15     ------> TIM12_CH2
    */
    HAL_GPIO_DeInit(GPIOB, CUP_1_ECHO_Pin|CUP_2_ECHO_Pin);
