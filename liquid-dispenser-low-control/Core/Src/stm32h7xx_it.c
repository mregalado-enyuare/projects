...
void EXTI1_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(CUBE_ICE_DONE_Pin);
...
void EXTI2_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(APDS9960_INT_Pin);
...
void EXTI9_5_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(APDS9960_2_INT_Pin);
...
void EXTI15_10_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(PEBBLE_ICE_DONE_Pin);
